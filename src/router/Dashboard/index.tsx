...
function DashboardRoutes() {
  ...
  const Explore: LazyExoticComponent<any> = lazy(
    () => import("../../pages/Dashboard/explore/Explore")
  );
  const Reels: LazyExoticComponent<any> = lazy(
    () => import("../../pages/Dashboard/reels/Reels")
  );
  const Profile: LazyExoticComponent<any> = lazy(
    () => import("../../pages/Dashboard/profile/Profile")
  );
  const UserProfil: LazyExoticComponent<any> = lazy(
    () => import("../../pages/Dashboard/profilUser/ProfilUser")
  );
  const PostPage: LazyExoticComponent<any> = lazy(
    () => import("../../pages/Dashboard/post/Post")
  );
  const PostModal: LazyExoticComponent<any> = lazy(
    () => import("../../pages/Dashboard/modal/Modal")
  );
  const SavedPost: LazyExoticComponent<any> = lazy(
    () => import("../../pages/Dashboard/saved/Saved")
  );
  ...
  const Chats: LazyExoticComponent<any> = lazy(
    () => import("../../pages/Dashboard/chat/Chat")
  );
    ...
    <main className="grid grid-cols-12">
      ...
      <div className="col-span-10">
        <Routes>
          ...
          />
          <Route
            path="/edit-profile" // Edit Profile sahifasi
            element={
              <Suspense fallback={<div>Loading...</div>}>
                <EditProfile />
              </Suspense>
